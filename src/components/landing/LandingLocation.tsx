    ...
    <section className="py-24 bg-netflix-gray-dark/50 relative">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 space-y-4">
          ...
          <p className="text-netflix-gray-light max-w-xl mx-auto text-lg font-medium">Fica localizado na Vila Mogilar em Mogi das Cruzes, prontos para te receber com muito amor.</p>
        </div>
